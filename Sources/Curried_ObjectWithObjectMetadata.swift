...
extension Persistable where
    ...
    */
    public static func readAtIndex<
        ReadTransaction>(index: YapDB.Index) -> (ReadTransaction) -> Self? where
    ...
    */
    public static func readAtIndexes<
        Indexes, ReadTransaction>(indexes: Indexes) -> (ReadTransaction) -> [Self] where
        Indexes: Sequence,
    ...
    */
    public static func readByKey<
        ReadTransaction>(key: String) -> (ReadTransaction) -> Self? where
        ReadTransaction: ReadTransactionType {
    ...
    */
    public static func readByKeys<
        Keys, ReadTransaction>(keys: Keys) -> (ReadTransaction) -> [Self] where
        Keys: Sequence,
