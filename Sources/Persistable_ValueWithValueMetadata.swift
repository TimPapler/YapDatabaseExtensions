...
extension Persistable where
    ...
    */
    public func asyncWrite<Connection: ConnectionType>(_ connection: Connection, queue: DispatchQueue = .main, completion: ((Self) -> Void)? = .none) {
...
extension Sequence where
    ...
    Iterator.Element.MetadataType: ValueCoding,
    Iterator.Element.MetadataType.Coder: NSCoding,
    Iterator.Element.MetadataType.Coder.Value == Iterator.Element.MetadataType {
    ...
    */
    ...
    - returns: a closure which receives as an argument the receiver of this function.
    */
    public func asyncWrite<Connection: ConnectionType>(_ connection: Connection, queue: DispatchQueue = .main, completion: (([Iterator.Element]) -> Void)? = .none) {
        return connection.asyncWrite(self, queue: queue, completion: completion)
    }
