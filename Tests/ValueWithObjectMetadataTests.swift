...
class ValueWithObjectMetadataTests: XCTestCase {
    ...
    func checkTransactionDidReadMetadataItem(_ result: TypeUnderTest.MetadataType?) -> Bool {
    ...
    func checkTransactionDidReadMetadataItems(_ result: [TypeUnderTest.MetadataType]) -> Bool {
